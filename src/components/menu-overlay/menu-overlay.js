                  ...
                  <nav class="nav-menu">
                     <ul class="menu-list">
                        <li class="hover-menu__item">
                          <a href="#home" class="hover-menu__link">Home</a>
                        </li>
                        <li class="hover-menu__item">
                          <a href="#features" class="hover-menu__link">Features</a>
                        </li>
                        <li class="hover-menu__item">
                          <a href="#usage" class="hover-menu__link">How it works</a>
                        </li>
                        <li class="hover-menu__item">
                          <a href="#feedback" class="hover-menu__link">Review</a>
                        </li>
                        <li class="hover-menu__item">
                          <a href="#contacts" class="hover-menu__link">Contact us</a>
                        </li>
                     </ul>
                  </nav>
               </div>
